...
Total spend across the full series: **~$15** (original $1.70 + v3 single-arm pods + Track B/C/D infrastructure runs). Raw artifacts in `results/gate2_fairness_20260419/` (original 120 s) and `results/gate2_preprint_v3/` (300 s preprint).
